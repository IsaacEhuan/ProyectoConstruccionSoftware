...
public class VerificadorArchivo {
    ...
    public boolean verificarExistenciaArchivo(String ruta, String nombre){
        try{
            ...
            while ((lineaUser = brUser.readLine()) != null) {
                ...
                if(!estructuraCorrecta(datosUser.length,4)) {
    ...
    public boolean estructuraCorrecta(int numElementos, int elementosEsperados){
        return numElementos == elementosEsperados;
    }
